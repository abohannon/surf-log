...
class LocationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create location" do
    assert_difference('Location.count') do
      post locations_url, params: { location: { city: @location.city, country: @location.country, description: @location.description, lat: @location.lat, lon: @location.lon, name: @location.name, state: @location.state } }
    end
